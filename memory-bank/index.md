...
- [_terms.md](_terms.md) — the dictionary and the ONLY place descriptions live: context `device` —
  ...
  CombinationFork, RunLengthEncoding, FixedPointOverlay (the catalog- and shell-level invariants
  live in the two specs below, not as blocks of their own)
...
- [specs/tasks/A100001.md](specs/tasks/A100001.md) · [specs/tasks/A000001.md](specs/tasks/A000001.md) ·
  [specs/tasks/A000002.md](specs/tasks/A000002.md)
